...
public enum EnemyState { Idle, Walk, SideAttack, LowerAttack, UpperAttack, Init }

// 構造体 struct
[System.Serializable]
public struct AnimationData
{
    public EnemyState state;            // 状態 (待機/移動/攻撃)
...
public class EnemyAnimation : MonoBehaviour
{
    ...
    // 辞書機能
    private Dictionary<EnemyState, AnimationData> animDictionary = new Dictionary<EnemyState, AnimationData>();
    ...
    public void ChangeState(EnemyState changedState)
    {
